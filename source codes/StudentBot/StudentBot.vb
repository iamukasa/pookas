...
Public Class StudentBot
    ...
    Private Sub RandomWalk(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Walker.Tick
        ...
        '80% chance to walk in a random direction
        ...
        '60% chance to make a gesture randomly
        GestureChance = Dice.Next(70, 100)
        If GestureChance <= 10 Then
            BotGesture = 3
        ElseIf GestureChance <= 20 Then
            BotGesture = 6
        ElseIf GestureChance <= 30 Then
            BotGesture = 7
        ElseIf GestureChance <= 50 Then
            BotGesture = 2
